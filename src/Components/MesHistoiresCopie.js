                    ...
                    <table>
                        ...
                        {this.state.histoires.map(json => {
                            ...
                            return (
                                <tr key={json}>
                                    <td>{json}</td>
                                    <td><Link to="/jeu"> <button onClick={() => this.setCurrent(json)}><i class="fas fa-play"></i></button></Link></td>
                                    <td><Link to="/editeur"><button onClick={() => this.setCurrent(json)}><i class="fas fa-pen"></i></button></Link></td>
                                    <td><button onClick={() => this.downloadFile(json)}><i class="fas fa-file-download"></i></button></td>
                                    <td><button onClick={() => this.supprimer(json)}><i class="fas fa-trash"></i></button></td>
                                </tr>
                                );
                        })}  
                        </tbody>
